...
export const handleGetArticle = async (req, res) => {
    const {
        k = "",
        p = "1",
        category = "",
...
export const handleGetArticleLength = async (req, res) => {
    const {
        k = "",
        category = "",
        is_archived = "0"
...
export const handlePostArticle = async (req, res) => {
    if (req.userRole !== 2) {
        return res.status(403).send("Anda tidak memiliki akses");
    }
...
export const handlePatchArticle = async (req, res) => {
...
export const handleDeleteArticle = async (req, res) => {
    if (req.userRole !== 2) {
        return res.status(403).send("Anda tidak memiliki akses");
    }
